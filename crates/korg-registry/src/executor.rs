use crate::log::{CapabilityEvent, CapabilityJournal};
use crate::plan::{MutationStep, TransitionPlan};
use crate::types::EffectNode;
use chrono::Utc;
use uuid::Uuid;
...
impl CapabilityExecutor {
    ...
    fn attempt_micro_healing(
        ...
        if error.contains("lock file exists") || error.contains("stuck_lock") {
            ...
            let lock_path = korg_core::paths::project_root()
                .join(".korg")
