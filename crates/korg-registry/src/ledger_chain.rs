//! korg-ledger@v1 — tamper-evident hash-chain (Rust reference).
//!
//! This is the Rust implementation of the frozen `korg-ledger@v1` spec
//! (canonical text: korgex `spec/korg-ledger-v1/SPEC.md`, vendored under
//! `tests/conformance/`). It MUST produce byte-identical hashes to the Python
//! reference; that equivalence is proven by the conformance vectors in
//! `tests/conformance.rs`, which pin frozen tip hashes computed by Python.
//!
