...
| **Rust** | Rust | [`korg-verify`](../../crates/korg-verify) — standalone crate, zero workspace deps (`cargo install korg-verify`) | `cargo test -p korg-verify` |
...
(`crates/korg-registry/src/ledger_chain.rs`) chains every `CapabilityJournal`
