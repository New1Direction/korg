...
pub async fn dispatch_level(
    ...
    tui_tx: Option<tokio::sync::mpsc::Sender<crate::tui::TuiUpdate>>,
        ...
        set.spawn(async move {
            ...
            .await
            {
                Ok(Ok(res)) if res.crashed => {
                    ...
                    crate::metrics::record_worker_crashed(persona.name());
                ...
                Ok(Ok(res)) => {
                    ...
                    crate::metrics::record_worker_completed(persona.name());
                ...
                Err(_elapsed) => {
                    ...
                    crate::metrics::record_worker_timeout(persona.name());
    ...
    for slot in retry_queue {
        ...
        let worktree_path_str = crate::paths::worktree_dir(
