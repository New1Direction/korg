...
pub struct CapabilityResolver {
    ...
    pub leases: HashMap<String, CapabilityLease>,
    ...
    pub fn handle_transition_request(&mut self, request: TransitionRequest) -> TransitionResponse {
        ...
        let mut plan = match CapabilityPlanner::plan_transition(&self.nodes, &self.active_states, &request.id, request.target_state) {
            ...
            Err(e) => {
                ...
                crate::metrics::record_transition_failed(&capability_id, &e);
                return TransitionResponse {
                    plan_id,
                    status: TransitionState::Failed,
                    errors: vec![e],
        ...
        if let Err(e) = CapabilityValidator::validate_transition(&execution.plan, &self.nodes, &self.active_states) {
            ...
            crate::metrics::record_transition_rejected(&capability_id, &e);
            return TransitionResponse {
